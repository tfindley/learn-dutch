...
const CATEGORIES = [
  ...
  },
  {
    ...
    color: "#1a6b4a",
    words: [
      { nl: "de winkel", phonetic: "duh VIN-kul", en: "the shop", tip: "Plural: de winkels. 'Winkelen gaan' = to go shopping." },
      { nl: "de supermarkt", phonetic: "duh SOO-per-markt", en: "the supermarket", tip: "'Ik doe mijn boodschappen in de supermarkt.'" },
      { nl: "de markt", phonetic: "duh markt", en: "the market", tip: "'De Grote Markt' = the main square. 'Naar de markt gaan' = to go to the market." },
      { nl: "de winkelwagen", phonetic: "duh VIN-kul-vah-khun", en: "the shopping trolley", tip: "Winkel (shop) + wagen (cart). 'Heb je een winkelwagen nodig?' = Do you need a trolley?" },
      { nl: "de mand", phonetic: "duh mant", en: "the (shopping) basket", tip: "Small basket for a few items. 'Ik neem gewoon een mand.' = I'll just take a basket." },
      ...
      { nl: "de boodschappentas", phonetic: "duh BOHT-skhap-pun-tas", en: "the grocery bag", tip: "'Heb je een boodschappentas mee?' = Did you bring a bag?" },
      { nl: "de boodschappenlijst", phonetic: "duh BOHT-skhap-pun-layst", en: "the shopping list", tip: "'Wat staat er op de boodschappenlijst?' = What is on the shopping list?" },
      { nl: "de kassa", phonetic: "duh KAS-sah", en: "the checkout / till", tip: "'Ik betaal aan de kassa.' 'Betaalt u gepast?' is the classic cashier question." },
      { nl: "betalen", phonetic: "buh-TAH-lun", en: "to pay", tip: "Ik betaal, jij betaalt. 'Hoe wil je betalen?' = How do you want to pay?" },
      { nl: "gepast betalen", phonetic: "khuh-PAST buh-TAH-lun", en: "to pay exact change", tip: "'Betaalt u gepast?' = Are you paying exact change? Very common at Belgian tills." },
      { nl: "contant", phonetic: "kon-TANT", en: "cash", tip: "'Contant betalen' = to pay cash. Alternative: 'cash betalen'." },
      { nl: "de pinpas", phonetic: "duh PIN-pas", en: "the debit card", tip: "Also called 'de bankkaart'. 'Ik betaal met de pinpas.' = I'm paying by card." },
      { nl: "het wisselgeld", phonetic: "huht VIS-sul-khelt", en: "the change (money back)", tip: "Soft 'g'. 'Uw wisselgeld' = your change (what the cashier hands back)." },
      { nl: "de openingsuren", phonetic: "duh OH-puh-nings-uu-run", en: "the opening hours", tip: "'Wat zijn de openingsuren?' = What are the opening hours?" },
      { nl: "open", phonetic: "OH-pun", en: "open", tip: "'De winkel is open.' Opposite: gesloten." },
      { nl: "gesloten", phonetic: "khuh-SLOH-tun", en: "closed", tip: "Soft 'g'. 'Gesloten op zondag' = closed on Sunday." },
    ],
  },
  {
    id: "supermarkt",
    ...
    color: "#6c3483",
    words: [
      { nl: "de groenten", phonetic: "duh KHROO-tun", en: "vegetables (category)", tip: "Soft 'g'. The vegetable aisle. Singular: de groente." },
      { nl: "het fruit", phonetic: "huht frowt", en: "fruit (category)", tip: "'ui' vowel. Het fruit = fruit as a category. Individual fruits mostly take 'de'." },
      { nl: "de bakkerij", phonetic: "duh bak-kuh-RAY", en: "the bakery", tip: "Long 'ay' at end. Found in most Belgian supermarkets — fresh bread daily." },
      { nl: "het vlees", phonetic: "huht vlays", en: "meat", tip: "het-word. 'Ik eet geen vlees' = I don't eat meat." },
      { nl: "de vis", phonetic: "duh fis", en: "fish", tip: "Short 'i'. 'De visafdeling' = the fish counter." },
      { nl: "de zuivel", phonetic: "duh ZOW-vul", en: "dairy", tip: "'ui' vowel. The dairy section: milk, cheese, yoghurt, butter." },
      { nl: "de dranken", phonetic: "duh DRANK-un", en: "drinks", tip: "Plural of 'de drank'. The drinks aisle." },
      { nl: "de niet-voeding", phonetic: "duh NEET-foo-ding", en: "non-food", tip: "Niet (not) + voeding (food). Toiletries, cleaning products, etc." },
      { nl: "het brood", phonetic: "huht broht", en: "the bread", tip: "het-word! Long 'oo'. 'Een sneetje brood' = a slice of bread." },
      { nl: "de melk", phonetic: "duh melk", en: "the milk", tip: "'Een pak melk' = a carton of milk. Very common purchase!" },
      { nl: "de kaas", phonetic: "duh kaas", en: "the cheese", tip: "Long 'aa'. Belgium is famous for its cheese. 'Een stuk kaas' = a piece of cheese." },
      { nl: "het ei / de eieren", phonetic: "huht ay / duh AY-yuh-run", en: "the egg / the eggs", tip: "het ei (singular) → de eieren (plural). Common mistake: never 'de ei'!" },
      { nl: "de boter", phonetic: "duh BOH-tur", en: "the butter", tip: "'Een pakje boter' = a pack of butter. -er ending reduces to schwa: [BOH-tuh]." },
      { nl: "de yoghurt", phonetic: "duh YOH-khurt", en: "the yoghurt", tip: "Soft 'g'. 'Een potje yoghurt' = a small pot of yoghurt." },
      { nl: "de room", phonetic: "duh rohm", en: "the cream", tip: "Long 'oo'. Not to be confused with 'de look' (garlic)! 'Slagroom' = whipped cream." },
      { nl: "de ham", phonetic: "duh ham", en: "the ham", tip: "Short 'a'. 'Een sneetje ham' = a slice of ham." },
      { nl: "de zalm", phonetic: "duh zalm", en: "the salmon", tip: "Short 'a'. 'Een stuk zalm' = a piece of salmon." },
      { nl: "de tonijn", phonetic: "duh toh-NAYN", en: "the tuna", tip: "'ij' = 'eye' sound. 'Een blik tonijn' = a tin of tuna." },
      { nl: "de mossel / mosselen", phonetic: "duh MOS-sul / MOS-suh-lun", en: "the mussel / mussels", tip: "Classic Belgian dish! Mosselen met frietjes. Note: 'mosselen' not 'mossels'." },
      { nl: "het bier / bieren", phonetic: "huht beer / BEE-run", en: "the beer / beers", tip: "het-word. Belgium has 1500+ beers. 'Een fles bier' = a bottle of beer." },
      { nl: "de wijn", phonetic: "duh vayn", en: "the wine", tip: "'ij' = 'eye'. 'Een fles wijn' = a bottle of wine." },
      { nl: "het fruitsap", phonetic: "huht FROWT-sap", en: "the fruit juice", tip: "het-word. 'Een brik fruitsap' = a carton of fruit juice." },
      { nl: "de chocolade", phonetic: "duh shoh-koh-LAH-duh", en: "the chocolate", tip: "Uncountable as a substance. 'Een reep chocolade' = a bar of chocolate." },
      { nl: "de confituur", phonetic: "duh kon-fee-TUUR", en: "the jam", tip: "Belgian Dutch! NL Dutch uses 'jam'. 'Een pot confituur' = a jar of jam." },
      { nl: "de look", phonetic: "duh look", en: "the garlic", tip: "Belgian Dutch for garlic! NL Dutch: 'knoflook'. 'Een teentje look' = a clove of garlic." },
      { nl: "de koekjes", phonetic: "duh KOOK-yuhs", en: "the cookies / biscuits", tip: "Diminutive plural of 'koek'. 'Een doos koekjes' = a box of biscuits." },
      { nl: "de tandpasta", phonetic: "duh TANT-pas-tah", en: "the toothpaste", tip: "Tand (tooth) + pasta. 'Een tube tandpasta' = a tube of toothpaste." },
      { nl: "de zeep", phonetic: "duh zayp", en: "the soap", tip: "Long 'ee'. 'Een stuk zeep' = a bar of soap." },
      { nl: "de shampoo", phonetic: "duh sham-POO", en: "the shampoo", tip: "English loanword. 'Een fles shampoo' = a bottle of shampoo." },
      { nl: "het waspoeder", phonetic: "huht VAS-poo-dur", en: "the washing powder", tip: "het-word. Wassen (to wash) + poeder (powder). 'Een pak waspoeder' = a pack of washing powder." },
      { nl: "het afwasmiddel", phonetic: "huht AF-vas-mid-ul", en: "the dish soap", tip: "het-word. Afwassen (to wash up) + middel (product). 'Een fles afwasmiddel'." },
    ],
  },
  {
    id: "containers",
    ...
    color: "#784212",
    words: [
      { nl: "een reep / repen", phonetic: "ayn rayp / RAY-pun", en: "a bar / bars", tip: "For chocolate and similar. 'Een reep chocolade' = a bar of chocolate." },
      { nl: "een sneetje / sneetjes", phonetic: "ayn SNAYT-yuh / SNAYT-yuhs", en: "a slice / slices", tip: "Diminutive of 'snee'. Thin slices: bread, ham, cheese. 'Een sneetje brood'." },
      { nl: "een stuk / stukken", phonetic: "ayn stuk / STUK-kun", en: "a piece / pieces", tip: "General word for a chunk or piece. 'Een stuk kaas' = a piece of cheese." },
      { nl: "een blik / blikken", phonetic: "ayn blik / BLIK-kun", en: "a tin/can / tins", tip: "Metal container. 'Een blik tonijn' = a tin of tuna. 'Een blik tomaten'." },
      { nl: "een doos / dozen", phonetic: "ayn dohs / DOH-zun", en: "a box / boxes", tip: "Long 'oo'. Plural: dozen (like English dozen!). 'Een doos koekjes' = a box of biscuits." },
      { nl: "een pakje", phonetic: "ayn PAK-yuh", en: "a small pack", tip: "Diminutive of pak. 'Een pakje boter' = a small pack of butter." },
      { nl: "een pak / pakken", phonetic: "ayn pak / PAK-kun", en: "a pack / packs", tip: "Larger pack. 'Een pak melk' = a carton of milk. 'Een pak waspoeder' = a pack of washing powder." },
      { nl: "een brik / brikken", phonetic: "ayn brik / BRIK-kun", en: "a carton / cartons", tip: "A drink carton (Tetra Pak type). 'Een brik fruitsap' = a carton of juice." },
      { nl: "een pot / potten", phonetic: "ayn pot / POT-tun", en: "a jar / jars", tip: "Short 'o'. 'Een pot confituur' = a jar of jam. 'Een pot pindakaas' = a jar of peanut butter." },
      { nl: "een potje / potjes", phonetic: "ayn POT-yuh / POT-yuhs", en: "a small jar / small jars", tip: "Diminutive of pot. 'Een potje yoghurt' = a small pot of yoghurt." },
      { nl: "een fles / flessen", phonetic: "ayn fles / FLES-sun", en: "a bottle / bottles", tip: "Short 'e'. 'Een fles wijn' = a bottle of wine. 'Een fles shampoo'." },
      { nl: "een zak / zakken", phonetic: "ayn zak / ZAK-kun", en: "a bag / bags", tip: "Short 'a'. 'Een zak aardappels' = a bag of potatoes. 'Een zak chips' = a bag of crisps." },
      { nl: "een bak / bakken", phonetic: "ayn bak / BAK-kun", en: "a tray/punnet / trays", tip: "Short 'a'. Used for soft fruit. 'Een bak aardbeien' = a punnet of strawberries." },
      { nl: "een tros", phonetic: "ayn tros", en: "a bunch (on vine)", tip: "For things that grow in clusters: 'een tros bananen', 'een tros druiven'." },
      { nl: "een bos / bossen", phonetic: "ayn bos / BOS-sun", en: "a bunch (tied)", tip: "For herbs, flowers: 'een bos peterselie' = a bunch of parsley. Different from 'tros'." },
    ],
  },
  {
    id: "fruit_veg",
    ...
    color: "#27ae60",
    words: [
      { nl: "de sinaasappel", phonetic: "duh sin-aas-AP-pul", en: "the orange", tip: "Sinaas (from China) + appel. Lit. 'China apple'! Plural: de sinaasappels." },
      { nl: "de appel", phonetic: "duh AP-pul", en: "the apple", tip: "Short 'a'. Plural: de appels." },
      { nl: "de peer", phonetic: "duh payr", en: "the pear", tip: "Long 'ee'. Plural: de peren — open syllable keeps it long: pe-ren." },
      { nl: "de kers", phonetic: "duh kers", en: "the cherry", tip: "Short 'e'. Plural: de kersen." },
      { nl: "de aardbei", phonetic: "duh AART-bay", en: "the strawberry", tip: "Aard (earth) + bei (berry). Plural: de aardbeien. 'Een bak aardbeien' = a punnet." },
      { nl: "de banaan", phonetic: "duh bah-NAAN", en: "the banana", tip: "Long 'aa'. Plural: de bananen. 'Een tros bananen' = a bunch of bananas." },
      { nl: "de citroen", phonetic: "duh sit-ROON", en: "the lemon", tip: "'oe' = long 'oo'. Plural: de citroenen." },
      { nl: "de kiwi", phonetic: "duh KEE-wee", en: "the kiwi", tip: "Plural: de kiwis — foreign word ending in vowel takes -'s? No — kiwi takes -s directly." },
      { nl: "de druif", phonetic: "duh drowf", en: "the grape", tip: "'ui' vowel. Plural: de druiven — f→v rule! 'Een tros druiven' = a bunch of grapes." },
      { nl: "de noot", phonetic: "duh noht", en: "the nut", tip: "Long 'oo'. Plural: de noten. Diminutive: het nootje / nootjes." },
      { nl: "de wortel", phonetic: "duh VOR-tul", en: "the carrot", tip: "'w' → 'v'. Plural: de wortelen (also wortels)." },
      { nl: "de aardappel", phonetic: "duh AART-ap-pul", en: "the potato", tip: "Aard (earth) + appel. Lit. 'earth apple'! Plural: de aardappels." },
      { nl: "de tomaat", phonetic: "duh toh-MAAT", en: "the tomato", tip: "Botanically a fruit — sold with vegetables in the shop! Plural: de tomaten." },
      { nl: "de broccoli", phonetic: "duh BROK-koh-lee", en: "the broccoli", tip: "No plural change. Italian origin. 'Een stuk broccoli' or just 'broccoli'." },
      { nl: "de bloemkool", phonetic: "duh BLOOM-kohl", en: "the cauliflower", tip: "Bloem (flower) + kool (cabbage). Note spelling: bloemkool, not bloomkool." },
      { nl: "de champignon", phonetic: "duh sham-pin-YON", en: "the mushroom", tip: "French origin, French pronunciation: [sham-pin-YON]. Plural: de champignons." },
      { nl: "de aubergine", phonetic: "duh oh-ber-ZHEEN", en: "the aubergine", tip: "French origin. 'zh' = like 's' in 'measure'. Plural: de aubergines." },
      { nl: "de look", phonetic: "duh look", en: "the garlic", tip: "Belgian Dutch! NL Dutch uses 'knoflook'. 'Een teentje look' = a clove of garlic." },
      { nl: "de mossel", phonetic: "duh MOS-sul", en: "the mussel", tip: "Plural: de mosselen (not 'mossels'!). Mosselen met frietjes = the Belgian classic." },
    ],
  },
];
